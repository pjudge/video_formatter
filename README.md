This small, custom D8 module provides a field formatter for entity reference fields (set to Remote Videos) to allow for videos from the media library to be lazy loaded.
